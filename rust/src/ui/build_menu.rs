...
pub(crate) fn build_kind_name(kind: BuildKind) -> &'static str {
    match kind {
        BuildKind::Farm => "Farm",
            ...
            ui.horizontal(|ui| {
                for option in options {
                    ...
                    let resp = ui.vertical(|ui| {
                        ...
                        ui.label(egui::RichText::new(format!("{} ({})", option.label, option.cost)).color(label_color));
                        ui.label(egui::RichText::new(option.help).color(egui::Color32::from_rgb(140, 140, 140)).small());
                    });
                ...
                ui.vertical(|ui| {
                    ...
                    ui.label(egui::RichText::new("Destroy").color(label_color).small());
                    ui.label(egui::RichText::new("Remove building").color(egui::Color32::from_rgb(140, 140, 140)).small());

                    if ui.interact(ui.min_rect(), egui::Id::new("destroy_btn_area"), egui::Sense::click()).clicked() {
                        if destroy_selected {
                            build_ctx.selected_build = None;
                        } else {
