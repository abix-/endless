...
rust/
  ...
  assets/                 # Standard Bevy asset dir (embedded in release builds via bevy_embedded_assets)
    ...
    shaders/
      npc_compute.wgsl      # WGSL compute shader (movement + spatial grid + combat targeting + tile_flags road system: speed bonus + collision bypass + attraction + wall collision: faction-aware enemy blocking)
