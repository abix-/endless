...
| [economy.md](economy.md) | Farm growth, food theft, starvation, raider foraging, unified building spawners, dynamic raider town migration (spawn→wander→settle) | 7/10 |
...
rust/
  ...
  src/ui/
    ...
    main_menu.rs        # Main menu with difficulty presets (Easy/Normal/Hard), world config sliders (farms + gold mines top-level, NPC home sliders driven by NPC_REGISTRY under AI Towns/Raider Towns), Play / Load Game / Debug Tests, restart tutorial button
    ...
    build_menu.rs       # Bottom-center build bar: data-driven from BUILDING_REGISTRY (player_buildable/raider_buildable filter), cached atlas extraction, click-to-place, destroy mode, cursor hint
