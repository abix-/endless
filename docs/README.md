...
rust/
  ...
  src/messages.rs       # Static queues (GpuUpdate), Message types (DamageMsg unified NPC+building, BuildingDeathMsg), DirtyWriters SystemParam (dirty signal messages), CombatLogMsg
