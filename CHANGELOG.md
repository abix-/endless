...
- add guard patrol between 6 posts with day/night shifts
- add guard post turrets (individually upgradeable, 9999 levels)
...
- add roster panel (R key) with sorting and filtering
...
- add expandable building grid (unlock adjacent slots, up to 100x100)
...
- add scroll speed and HP bar mode settings
